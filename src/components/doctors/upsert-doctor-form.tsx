...
const formSchema = z
  .object({
    ...
    appointmentPrice: z
      .number()
      .min(1, { message: "Preço da consulta deve ser maior que zero" }),
              ...
              render={({ field }) => (
                <FormItem className="w-full">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectGroup>
                        <SelectLabel className="text-sm">Manhã</SelectLabel>
                      ...
                      <SelectGroup>
                        <SelectLabel className="text-sm">Tarde</SelectLabel>
                      ...
                      <SelectGroup>
                        <SelectLabel className="text-sm">Noite</SelectLabel>
